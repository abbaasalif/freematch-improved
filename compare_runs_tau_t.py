...
data_original = pd.read_csv('./run_data/run-freematch_cifar10_4000_original_tensorboard_runs_cifar_10_4000_run_0-tag-train_tau_t.csv')
data_mod1 = pd.read_csv('./run_data/run-freematch_cifar10_4000_modification1_tensorboard_runs_cifar_10_4000_run_0-tag-train_tau_t.csv')
data_mod2 = pd.read_csv('./run_data/run-freematch_cifar10_4000_modification_2_tensorboard_runs_cifar_10_4000_1_run_0-tag-train_tau_t.csv')
data_mod3 = pd.read_csv('./run_data/run-freematch_cifar10_4000_modification_3_tensorboard_runs_cifar_10_4000_2_run_0-tag-train_tau_t.csv')
...
plt.title('Comparison of CIFAR-10 Train Gloabal Threshold (tau_t) Across Modifications')
plt.xlabel('Step')
plt.ylabel('Train Gloabal Threshold (tau_t)')
plt.legend()
plt.grid(True)

# Save plot to file
plt.savefig('comparison_chart_train_tau_t.png')
...
# Save plot to file
plt.savefig('comparison_chart_train_tau_t_zoomed.png')
